...
public class JSpot extends JPanel implements MouseListener, Spot {
	...
	private int _x;
	private int _y;
// record whether the spot has been clicked to make it not highlighted
// when it is entered after being clicked
	private boolean _is_clicked;
...
// should use trigger_update whenever the UI is updated
	@Override
